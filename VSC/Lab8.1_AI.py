...
# Создание GММ
classifier = GaussianMixture(n_components=num_classes, covariance_type='full', init_params='kmeans', max_iter=40)
...
#  ellipse = patches.Ellipse(classifier.means_[i, :2], eigenvalues[0], eigenvalues[1], 180 + angle, color=color)
 ellipse = patches.Ellipse(xy=(classifier.means_[i, 0], classifier.means_[i, 1]), width=eigenvalues[0], height=eigenvalues[1], angle=180 + angle, color=color)
